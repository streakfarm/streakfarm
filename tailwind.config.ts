  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        // Box rarity colors
        "box-common": "hsl(var(--box-common))",
        "box-rare": "hsl(var(--box-rare))",
        "box-legendary": "hsl(var(--box-legendary))",
        // Badge rarity
      ...
      boxShadow: {
        ...
        "glow-legendary": "0 0 40px hsl(var(--rarity-legendary) / 0.5)",
        "glow-mythic": "0 0 50px hsl(var(--rarity-mythic) / 0.6)",
      },
    },
  },
